...
export const AppRouteRenderer: React.FC<AppRouteRendererProps> = ({
    ...
    if (currentRoute === 'discover') return <DiscoveryDashboard onItemClick={() => {}} mediaServerType={sessionInfo?.mediaServerType} isAdmin={isAdmin} showPosterQualityBadges={effectivePublicConfig?.showPosterQualityBadges !== false} />;
    ...
    if (currentRoute === 'request' && (effectivePublicConfig?.requestEngine === 'portal' || sessionInfo?.requestEngine === 'portal')) {
        ...
        return <DiscoveryDashboard onItemClick={() => {}} mediaServerType={sessionInfo?.mediaServerType} isAdmin={isAdmin} showPosterQualityBadges={effectivePublicConfig?.showPosterQualityBadges !== false} />;
    }
