...
export const useSettingsHydration = ({
    ...
    useEffect(() => {
        ...
        hydrateSettingsFromConfig(initialSettings, {
            ...
            setInboundRepliesEnabled: set('inboundRepliesEnabled'),
            setInboundReplyDomain: set('inboundReplyDomain'),
            setInboundReplyReady: set('inboundReplyReady'),
            ...
            setDiscordMemberChannelId: set('discordMemberChannelId'),
            ...
            setDiscordAdminWebhookUrl: set('discordAdminWebhookUrl'),
            ...
            setDiscordNotifyAnnouncements: set('discordNotifyAnnouncements'),
            setDiscordNotifyBroadcasts: set('discordNotifyBroadcasts'),
            setDiscordNotifyNewsletters: set('discordNotifyNewsletters'),
            setDiscordNotifyMediaReady: set('discordNotifyMediaReady'),
            setDiscordMediaAnnounceDebounceMinutes: set('discordMediaAnnounceDebounceMinutes'),
            ...
            setQcTrimEnabled: set('qcTrimEnabled'),
            setQcTrimDryRun: set('qcTrimDryRun'),
            setQcTrimLanguages: set('qcTrimLanguages'),
            setQcTrimKeepNativeAudio: set('qcTrimKeepNativeAudio'),
            setQcTrimStripCommentary: set('qcTrimStripCommentary'),
            ...
            setQcIntegrityTrimConcurrency: set('qcIntegrityTrimConcurrency'),
            ...
            setQcIntegrityDecodeRetries: set('qcIntegrityDecodeRetries'),
            setQcIntegritySoftDecodeTimeouts: set('qcIntegritySoftDecodeTimeouts'),
