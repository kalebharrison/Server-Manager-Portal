...
export const buildSmtpTabPanelProps = ({
    ...
    inboundReplyReady: values.inboundReplyReady,
    ...
    onInboundRepliesEnabledChange: onChange('inboundRepliesEnabled'),
    onInboundReplyDomainChange: onChange('inboundReplyDomain'),
