...
export const useSettingsFormState = () => {
    ...
    const createSavePayload = useCallback((adminValues: SaveAdminValues) => buildSettingsSavePayload({
        ...
        qcIntegrityTrimConcurrency: values.qcIntegrityTrimConcurrency,
        ...
        qcIntegrityDecodeRetries: values.qcIntegrityDecodeRetries,
        qcIntegritySoftDecodeTimeouts: values.qcIntegritySoftDecodeTimeouts,
