...
export const useSettingsFormState = () => {
    ...
    const createSavePayload = useCallback((adminValues: SaveAdminValues) => buildSettingsSavePayload({
        ...
        requestEngine: values.requestEngine,
        ...
        scannerEnabled: values.scannerEnabled,
        scannerHomeWidgetEnabled: values.scannerHomeWidgetEnabled,
        scannerWebhooksVisible: values.scannerWebhooksVisible,
        scannerManualPathVisible: values.scannerManualPathVisible,
