...
export const discoveryTheme = {
    ...
    tabBar: 'w-full flex flex-wrap items-center gap-1 p-1 rounded-xl bg-white/[0.04] border border-border/80',
    ...
    tabSticky: 'sticky top-0 z-30 -mx-1 px-1 py-2 bg-background/95',
    ...
    heroChip: 'inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[11px] sm:text-xs font-bold border border-border/80 bg-background/90 text-text hover:bg-plex hover:text-background hover:border-plex transition-colors',
