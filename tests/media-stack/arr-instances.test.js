...
import { getReadyArrInstances, normalizeArrConfig, sanitizeArrInstances } from '../../lib/media-stack/arr-instances.js';

test('legacy Arr settings migrate and additional instances preserve one default', async () => {
    ...
    const instances = await sanitizeArrInstances([
