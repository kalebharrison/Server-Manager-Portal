...
export const registerJellyfinRoutes = ({
    ...
    app.get('/api/jellyfin/image', requireAuth, requireMember, memberApiRateLimit || ((req, res, next) => next()), async (req, res) => {
    ...
    app.get('/api/jellyfin/user-image', requireAuth, requireMember, memberApiRateLimit || ((req, res, next) => next()), async (req, res) => {
    ...
    app.get('/api/jellyfin/sessions', requireAuth, requireMember, memberApiRateLimit || ((req, res, next) => next()), async (req, res) => {
        try {
            const config = await loadFile(CONFIG_PATH, {});
    ...
    app.get('/api/jellyfin/dashboard', requireAuth, requireMember, memberApiRateLimit || ((req, res, next) => next()), async (req, res) => {
        try {
            const config = await loadFile(CONFIG_PATH, {});
