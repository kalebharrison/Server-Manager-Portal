...
import { createDiscordRequestApp } from '../discord/discord-request-app.js';
import { CONFIG_DIR, CONFIG_PATH, USERS_PATH } from '../config/data-paths.js';
...
export const createPortalServices = ({
    ...
    let onRequestStatusChange = async () => {};
    const discordRequestApp = createDiscordRequestApp({
        loadFile: authFoundation.loadFile,
        configPath: CONFIG_PATH,
        usersPath: USERS_PATH,
        configDir: CONFIG_DIR,
        resolveUrl: resolveIntegrationUrlForFetch,
        onRequestStatusChange: (...args) => onRequestStatusChange(...args),
    });
    const discordService = createDiscordService({
        ...
        configPath: CONFIG_PATH,
        usersPath: USERS_PATH,
        getRequestAppService: () => discordRequestApp,
        getPlexConnectionUri: media.getPlexConnectionUri,
    ...
    onRequestStatusChange = comms.memberNotifications.notifyRequestUpdate;
    ...
    const ops = createPortalOpsStack({
        ...
        loadFile: authFoundation.loadFile,
        loadFileShared: authFoundation.loadFileShared,
        saveFile: authFoundation.saveFile,
