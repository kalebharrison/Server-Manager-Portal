...
import { createTvdbService } from '../metadata/tvdb-service.js';
import { createMetadataHealthProbe } from '../metadata/metadata-health.js';
...
export const createPortalMediaUserStack = ({
    ...
    if (typeof resolveIntegrationUrlForFetch !== 'function') {
        throw new Error('createPortalMediaUserStack requires resolveIntegrationUrlForFetch.');
    }
