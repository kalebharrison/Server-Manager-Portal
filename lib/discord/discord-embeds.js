...
import { tmdbImageUrl } from '../request-app/request-app-media-images.js';
...
export const resolveDiscordPosterUrl = (item = {}, { size = 'w500' } = {}) => {
    ...
    try {
        ...
        // Seerr imageproxy: .../imageproxy/tmdb/t/p/w500/abc.jpg
    ...
    if (/^https:\/\//i.test(rawUrl) && !/\/api\/request-app\/image/i.test(rawUrl)) return rawUrl;
    return '';
};
