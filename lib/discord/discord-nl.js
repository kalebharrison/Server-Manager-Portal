...
export const createDiscordNlParser = ({
    ...
    const parseWithLlm = async (config, text) => {
        ...
        const system = [
            ...
            'Use agent.discover for any media discovery / recommendation / “what should I watch” / multi-constraint title questions (include params.query as the full user text).',
            ...
            'If unclear and not clearly ops, return {"intent":"agent.discover","params":{"query":"<user text>"}}.',
        ].join(' ');
