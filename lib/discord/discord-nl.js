...
export const createDiscordNlParser = ({
    ...
    const parseWithLlm = async (config, text) => {
        ...
        const system = [
            ...
            'For request.search include params.query (title, franchise, or person name only — no trailing words like movie, film, tv show, or latest) and optional params.mediaType (movie|tv|all).',
