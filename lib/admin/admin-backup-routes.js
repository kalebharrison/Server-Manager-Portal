...
export const registerAdminBackupRoutes = ({
    ...
    // POST: mutating export must not be CSRF-triggerable via a bare GET navigation.
    app.post('/api/admin/backup', requireAdmin, adminSensitiveRateLimit, async (req, res) => {
        try {
