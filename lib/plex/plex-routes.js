...
export const registerPlexRoutes = ({
    ...
    app.get('/api/plex/image', requireAuth, requireMember, memberApiRateLimit || ((req, res, next) => next()), memberApiRateLimit || ((req, res, next) => next()), async (req, res) => {
    ...
    app.get('/api/plex/library', requireAuth, requireMember, memberApiRateLimit || ((req, res, next) => next()), async (req, res) => {
        try {
            const { config, uri } = await loadPlexContext();
    ...
    app.get('/api/plex/search', requireAuth, requireMember, memberApiRateLimit || ((req, res, next) => next()), async (req, res) => {
    ...
    app.get('/api/plex/sessions', requireAuth, requireMember, memberApiRateLimit || ((req, res, next) => next()), memberApiRateLimit || ((req, res, next) => next()), async (req, res) => {
        try {
            const { config, uri } = await loadPlexContext();
    ...
    app.get('/api/plex/dashboard', requireAuth, requireMember, memberApiRateLimit || ((req, res, next) => next()), memberApiRateLimit || ((req, res, next) => next()), async (req, res) => {
        try {
            const { config, uri } = await loadPlexContext();
