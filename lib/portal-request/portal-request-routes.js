...
export const registerPortalRequestRoutes = ({
    ...
    /**
     * Scan Radarr/Sonarr: map legacy/bare requester tags → portal users, and
     * attach missing portal-format `{portalUserId}-{username}` tags on the media.
    ...
    /**
     * Optional: seed portal JSON request rows from Arr tags (My Requests history).
     * Prefer Arr tags as ownership SoT; use only if you need portal rows.
     */
