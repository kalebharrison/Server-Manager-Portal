...
export const registerPortalRequestRoutes = ({
     ...
     * attach missing media-server `{plexOrJellyfinId}-{username}` tags on the media.
     * Also migrates portal notifyUserIds → Arr `n-…` tags. Does not dump ownership into JSON.
     */
