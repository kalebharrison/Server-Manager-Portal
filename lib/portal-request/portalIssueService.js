 ...
 * JSON store under config/issues.
 */

import { buildTmdbBackdropUrl, buildTmdbPosterUrl } from './requestDtoHelpers.js';
import {
    issueStatusLabel,
    issueTypeLabel,
    IssueStatus,
...
const ISSUE_STATUS_OPEN = IssueStatus.OPEN;
const ISSUE_STATUS_RESOLVED = IssueStatus.RESOLVED;
...
export const mapPortalIssueToDto = (record, user = {}) => {
    ...
    return {
        ...
        issueTypeLabel: issueTypeLabel(record?.issueType),
