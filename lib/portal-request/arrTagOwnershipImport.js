/**
 * Admin Arr catalog scan → upsert available portal request rows from requester tags.
 */
        ...
        for (const instance of instances) {
            ...
            for (const item of items) {
                ...
                if (matched) {
                    ...
                    // Had tags but none mapped to a portal user (quality/category tags, etc.)
...
export default importArrTagOwnershipToPortal;
