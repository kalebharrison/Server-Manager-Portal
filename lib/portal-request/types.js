 ...
 * @property {number | null} [status] 3 processing, 4 partial, 5 available
 * @property {string | null} [statusLabel]
 * @property {object | null} [mediaInfo] Media fragment for Discover UI overlays
 ...
 * @property {number} status 1 pending, 2 approved, 3 declined, 4 failed
