...
const DOWNLOAD_CLIENT_FALLBACKS = {
...
export const createPublicStatusPayload = (statusConfig = {}, healthData = {}) => {
    ...
    const publicServiceName = (service = {}) => {
        ...
        if (DOWNLOAD_CLIENT_FALLBACKS[service.id]) return DOWNLOAD_CLIENT_FALLBACKS[service.id].name;
    ...
    const publicServiceDescription = (service = {}) => {
        ...
        if (DOWNLOAD_CLIENT_FALLBACKS[service.id]) return DOWNLOAD_CLIENT_FALLBACKS[service.id].description;
