/**
 * Parse Arr/MediaInfo runtime values into seconds.
...
export const extractExpectedRuntimeSec = ({
    ...
    const mediaInfo = file?.mediaInfo || record?.mediaInfo || {};
    const fromMediaInfo = parseRuntimeToSec(mediaInfo.runTime || mediaInfo.duration || mediaInfo.runtime);
    if (fromMediaInfo != null) return fromMediaInfo;
