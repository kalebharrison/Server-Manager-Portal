 ...
 * DHT "UHDRemux" .mp4 files are encodes that Radarr still parses as Remux-2160p.
 */
export const isFakeRemuxContainer = ({ title, qualityName, files = [] } = {}) => {
    ...
    return names.some((name) => looksLikeMp4Name(name));
};
