...
export const buildNewsletterBodyContent = ({ recentHtml, uptimeStr, stats, publicDomain }) => `
                            ...
                            <tr>
                                <td align="center" style="padding: 30px; background-color: #0b0f19; border-top: 1px solid #1f2937;">
                                    ...
                                    <p style="margin: 0; color: #6b7280; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 12px;">Manage or unsubscribe anytime in your <a href="${publicDomain}" style="color: #eab308; text-decoration: none;">User Portal</a> preferences.</p>
                                </td>
                            </tr>
                        `;
