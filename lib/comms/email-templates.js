...
const LOGO_IMG = '<img src="cid:logo" alt="" height="36" style="display:block;height:36px;max-height:36px;width:auto;max-width:180px;border:0;margin:0 0 12px 0;" />';
    ...
    <tr>
      <td align="center" style="padding:24px 12px;">
        <table role="presentation" width="560" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff" style="background-color:#ffffff;border-collapse:collapse;">
          ...
          <tr>
            <td style="padding:20px 28px 0;font-family:Arial,Helvetica,sans-serif;color:#282A2D;">
...
export const buildMediaIssueReportHtml = ({ username, title, key, issue, links = [], config } = {}) => {
