...
import { maskArrInstances, normalizeArrConfig, sanitizeArrInstances } from './arr-instances.js';
...
import { normalizeCacheRefreshMinutes } from './cache-refresh.js';
...
export const registerConfigRoutes = ({
    ...
    app.post('/api/config', setupRateLimit, async (req, res) => {
        const {
            ...
            requestAppType, requestAppUrl, requestAppApiKey, ombiUrl, ombiApiKey,
