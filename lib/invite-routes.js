...
import { updateFile as updateJsonFile } from './json-file-store.js';
...
const findClaimableInvite = (invites, code) => {
...
export const registerInviteRoutes = ({
    ...
    app.post('/api/invites/:code/claim', authRateLimit, async (req, res) => {
        ...
        try {
            ...
            let invite;
            let newUser;
            await updateFile(INVITES_PATH, [], async (freshInvites) => {
                invite = findClaimableInvite(freshInvites, req.params.code);
                ...
                await updateFile(USERS_PATH, [], (freshUsers) => {
                ...
                recordInviteClaim(freshInvites, req.params.code, plexUser);
                return freshInvites;
            });
