...
export const DISCOVER_HOME_CACHE_PATH = dataPath('discover-home-cache.json');
export const DISCOVERY_AVAILABILITY_CACHE_PATH = dataPath('discovery-availability-cache.json');
export const MEDIA_ISSUES_PATH = dataPath('media-issues.json');
export const UPGRADER_INDEX_PATH = dataPath('upgrader-index.json');
export const UPGRADER_PREFS_PATH = dataPath('upgrader-preferences.json');
export const UPGRADER_AUDIT_PATH = dataPath('upgrader-audit.json');
export const UPGRADER_INTEGRITY_CACHE_PATH = dataPath('upgrader-integrity-cache.json');
