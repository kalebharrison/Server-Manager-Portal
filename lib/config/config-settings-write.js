...
export const buildConfigFromPostBody = async ({
    ...
    const {
        ...
        qcCleanupAutomationEnabled, qcMetaDlMinutes, qcStalledHours, qcSlowDownloadFloorKbps, qcSlowDownloadMinAgeHours, qcCompletedNotImportingMinutes, qcOrphanGraceMinutes, qcMaxStrikes,
    ...
    const resolvedIntegrityWebhookUsername = (() => {
        ...
        return String(
            existingConfig.qcIntegrityWebhookUsername
            || existingConfig.scanner?.authUsername
            || '',
        ).trim();
    })();
    const resolvedIntegrityWebhookPassword = resolveSecret(
        ...
        existingConfig.qcIntegrityWebhookPassword
            || existingConfig.scanner?.authPassword
            || '',
    );
