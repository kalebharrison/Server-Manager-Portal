...
import { sanitizeAssetUrl, sanitizeHttpUrl, sanitizePublicDomain } from '../http/public-url.js';
...
export const buildConfigFromPostBody = async ({
    ...
    const config = normalizeArrConfig({
        ...
        publicDomain: (() => {
            try {
                return sanitizePublicDomain(publicDomain);
            } catch (e) {
        ...
        contactUrl: (() => {
            try {
                return contactUrl ? sanitizeHttpUrl(contactUrl, { field: 'contactUrl' }) : '';
            } catch (e) {
                throw new Error(`Invalid settings URL: ${e.message}`);
            }
        })(),
        ...
        customLogoUrl: (() => {
            try {
                return sanitizeAssetUrl(customLogoUrl, { field: 'customLogoUrl' });
            } catch (e) {
                throw new Error(`Invalid settings URL: ${e.message}`);
            }
        })(),
        ...
        backgroundImageUrl: (() => {
            try {
                return sanitizeAssetUrl(backgroundImageUrl, { field: 'backgroundImageUrl' });
            } catch (e) {
                throw new Error(`Invalid settings URL: ${e.message}`);
            }
        })(),
