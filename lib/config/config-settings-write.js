...
export const buildConfigFromPostBody = async ({
    ...
    const {
        ...
        qcIntegrityPathMaps, qcIntegrityMaxPerCycle, qcIntegrityDecodeWindowSec, qcIntegrityDecodeTimeoutMs,
    } = body;
    ...
    const config = normalizeArrConfig({
        ...
        qcIntegrityMaxPerCycle: Math.max(
            1,
            Number(qcIntegrityMaxPerCycle ?? existingConfig.qcIntegrityMaxPerCycle ?? 25) || 25,
        ),
