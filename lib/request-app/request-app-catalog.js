...
import { createCatalogPerson } from './request-app-catalog-person.js';
import { createCatalogTheme } from './request-app-catalog-theme.js';
...
export const createRequestAppCatalog = ({
    ...
    const { searchPeople, getPerson, getPersonFilmography } = createCatalogPerson({
        getCredentials,
        cachedSeerrJson,
        proxyPoster,
        applyAcquisitionState,
    });
    const { discoverByTheme } = createCatalogTheme({
        getCredentials,
        cachedSeerrJson,
        proxyPoster,
        applyAcquisitionState,
