...
export const reconcileReplacement = async (config, issue, { fetch, resolveIntegrationUrlForFetch, requestAppService, plexGraphql, PLEX_CREATE_COMMENT_MUTATION }) => {
